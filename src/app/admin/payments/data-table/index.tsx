    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <Button
            variant="outline"
            onClick={() => onBulkAction("PAID", table.getFilteredSelectedRowModel().rows.map(row => row.original))}
          ...
          <Button
            variant="outline"
            onClick={() => onBulkAction("UNPAID", table.getFilteredSelectedRowModel().rows.map(row => row.original))}
            disabled={table.getFilteredSelectedRowModel().rows.length === 0}
          >
            Mark as Unpaid
          </Button>
